...
marker_to_depth_camera_path = "transform_ArucoBoard_to_depth_camera.npy"
...
# to_56_to_depth_camera_path = "transform_imfusion_world_ct_56_to_depth_camera.npy"
to_78_to_depth_camera_path = "transform_imfusion_world_ct_78_to_depth_camera.npy"
...
def main():
    ...
    world_to_cb_geom = np.array([[-0.218763008664988,  0.207065942321039,  0.953554634811526,  -43.2766500927332],  [-0.542560509019084, -0.838045784507831, 0.0575096263386161,   24.5547595825777],  [0.811030726972039, -0.504780109155814,  0.295679220284163,   376.548770523914],  [0,                  0,                  0,                  1]]
    ...
    world_to_cb_geom_34 = np.array([[-0.263631606332836,  0.412890808711538,  0.871791004899627,  -40.5032604356369],  [-0.415939597940903, -0.864085880625352,  0.283460476554791,   7.96508905387752],  [0.87034052359242, -0.287883259300436,  0.399537985687756,   379.634495859459],  [0,                  0,                  0,                  1]]
    ...
    world_to_cb_geom_56 = np.array([[-0.383993113405375,  0.439536394652021,  0.812008033601608,  -38.5473412481603],  [-0.684593119708782, -0.725647509665592, 0.0690503596190609,  -
                                                                                                                        58.0465628707011],  [0.619581753527848, -0.529380250380035,  0.579547238111725,   381.621274850155],  [0,                  0,                  0,                  1]])

    world_to_cb_geom_78 = np.array([[-0.333012399552806,  0.491726268380768,  0.804554546770079,  -42.9999616506563],  [-0.336740315298734, -0.859009323201799,  0.385627984857034,  -19.1916557846184],  [0.88074326667684, -0.142507051182432,  0.451644814612872,   379.496750809682],  [0,                  0,                  0,                  1]]
    ...
    if capture.color is not None and capture.depth is not None:
        ...
        o3d.visualization.draw_geometries(
            [pcd, ct_mesh, ct_mesh_34, ct_mesh_56, ct_mesh_78, ct_mesh_copy, ct_mesh_34_copy, ct_mesh_78_copy, camera_frame,
             board_mesh],
